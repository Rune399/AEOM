...
Om te helpen bij het opstellen van deze probleem-lijst, werd parallel een benchmark opgesteld, die ook van grote hulp was bij het kiezen van een finaal probleem. Deze benchmark werd afgelegd aan de hand van online beschikbare informatie. Voor meer informatie omtrent de benchmark zie <a src="../docs/S@H_Benchmark protocol.pdf">Benchmark protocol</a>.
